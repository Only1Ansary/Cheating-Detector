...
class GazeDetectorApp:
    def __init__(self, window):
        ...
        self.status_label = tk.Label(self.window, textvariable=self.status_text, font=('Helvetica', 14), bg='white', fg='green')
    ...
    def update(self):
        ...
        if ret:
            ...
            if results.multi_face_landmarks:
                ...
                if not self.face_not_detected and self.face_absent_counter >= 5:
                    self.face_not_detected = True
                    self.status_text.set("Status: NO FACE DETECTED")
